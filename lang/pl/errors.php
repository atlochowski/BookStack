...
return [
    ...
    // Import
    'import_zip_cant_read' => 'Nie można odczytać pliku ZIP.',
    'import_zip_cant_decode_data' => 'Nie można odnaleźć i zdekodować zawartości pliku ZIP data.json.',
    'import_zip_no_data' => 'Dane w pliku ZIP nie zawierają oczekiwanej zawartości książki, rozdziału lub strony.',
    'import_validation_failed' => 'Nie udało się zaimportować pliku ZIP, wystąpiły błędy:',
    'import_zip_failed_notification' => 'Nie udało się zaimportować pliku ZIP.',
    'import_perms_books' => 'Brakuje Ci uprawnień wymaganych do tworzenia książek.',
    'import_perms_chapters' => 'Brakuje Ci uprawnień wymaganych do tworzenia rozdziałów.',
    'import_perms_pages' => 'Brak uprawnień wymaganych do tworzenia stron.',
    'import_perms_images' => 'Brak uprawnień wymaganych do tworzenia obrazów.',
    'import_perms_attachments' => 'Brak uprawnień do tworzenia załączników.',
